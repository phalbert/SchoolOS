        ...
        <aside class="right-side" style="padding-left: 20px; padding-top: 50px;">
            ...
            <div class="row">
                ...
                <div class="col-lg-10 text-center">
                    <div class="alert">
                        <img src="ImageHandler.ashx?Id=Default" id="UsersPic" runat="server" class="img-thumbnail" style="width:400px;height:300px" /><br /><br />
                        <strong>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-3">
                            <div class="widget-bg-color-icon card-box">
                                ...
                                <div class="text-right">
                                    <h3 class="text-dark"><b id="widget_count1"><asp:Label ID="lblClassCount" runat="server">8</asp:Label></b></h3>
                                    <p>No. of Classes</p>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-3">
                            <div class="widget-bg-color-icon card-box border_success">
                                ...
                                <div class="text-right">
                                    <h3 class="text-success"><b id="widget_count3"><asp:Label ID="lblTeacherCount" runat="server">45</asp:Label></b></h3>
                                    <p>No. of Teachers</p>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-3">
                            <div class="widget-bg-color-icon card-box">
                                ...
                                <div class="text-right">
                                    <h3 class="text-dark"><b id="widget_count2"><asp:Label ID="lblStudentCount" runat="server">1698</asp:Label></b></h3>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-3">
                            <div class="widget-bg-color-icon card-box border_danger">
                                <div class="text-center">
                                    <h3 class="text-danger"><b id="widget_count4"><asp:Label ID="lblTranAmount" runat="server">110,000,000</asp:Label></b></h3>
