<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SaveUserType.ascx.cs" Inherits="CustomUserControls_SaveUserType" %>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-heading text-center">
                                    SUPPLY THE USERTYPE DETAILS USING FORM BELOW
                                </div>
                ...
                <div class="row" style="padding-top: 70px;">
                    ...
                    <div class="col-lg-8">
                        <div class="alert alert-info">
                            This UserType Already Exists! Are you sure you want to Update it.
                        </div>
                    </div>
                    <div class="col-lg-2"></div>
                </div>
