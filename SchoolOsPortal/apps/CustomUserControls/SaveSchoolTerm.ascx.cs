...
public partial class CustomUserControls_SaveSchoolTerm : System.Web.UI.UserControl
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string msg = "";
            SchoolTerm aclient = GetObject();
            Result result = schoolApi.SaveSchoolTerm(aclient);
    ...
    private SchoolTerm GetObject()
    {
        SchoolTerm std = new SchoolTerm();
        std.TermCode = SharedCommons.SharedCommons.GenerateUniqueId("TERM");
        std.TermName = txtName.Text;
        std.StartDate = txtStartDate.Text;
        std.EndDate = txtEndDate.Text;
