<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ApproveSchools.ascx.cs" Inherits="ApproveSchools" %>
            ...
            <asp:View runat="server" ID="resultView">
                <div class="row">
                    ...
                    <div class="row text-center">
                        <asp:Button ID="btnApprove" runat="server" Text="Admit" CssClass="btn btn-primary btn-lg"
                        ...
                        <asp:GridView runat="server" Width="100%" CssClass="table table-bordered table-hover"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Select">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkSelected" runat="server"  CommandName="Select" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
