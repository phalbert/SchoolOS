...
public partial class CustomUserControls_SaveExam : System.Web.UI.UserControl
{
    ...
    private void LoadData()
    {
        ...
        txtExamCode.Text = SharedCommons.SharedCommons.GenerateUniqueId("EXAM");
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string msg = "";
            Exam aclient = GetObject();
            Result result = schoolApi.SaveExams(aclient);
    ...
    private Exam GetObject()
    {
        Exam std = new Exam();
        std.ExamCode = txtExamCode.Text;
        std.ExamName = txtName.Text;
