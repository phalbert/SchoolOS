...
public partial class CustomUserControls_ListStaffMembers : System.Web.UI.UserControl
{
    ...
    private void SearchDB()
    {
        ...
        DataTable dt = bll.SearchTable("SearchStaffTable", searchParams);
        if (dt.Rows.Count > 0)
        {
    ...
    protected void dataGridResults_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            Result result = SaveStaffMembersUserControl.LoadEntityDataForEdit(studentID,schoolCode);
