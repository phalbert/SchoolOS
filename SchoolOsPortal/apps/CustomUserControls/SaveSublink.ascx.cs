...
public partial class CustomUserControls_SaveSublink : System.Web.UI.UserControl
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string msg = "";
            SubLink aclient = GetObject();
            Result result = schoolApi.SaveSubLink(aclient);
    ...
    private SubLink GetObject()
    {
        SubLink std = new SubLink();
        std.SubLinkCode = SharedCommons.SharedCommons.GenerateUniqueId("SUB-LINK");
        std.SubLinkName = txtName.Text;
        std.URL = ddURLs.SelectedValue;
