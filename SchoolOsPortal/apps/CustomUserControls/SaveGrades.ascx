<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SaveGrades.ascx.cs" Inherits="CustomUserControls_SaveGrades" %>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-heading text-center">
                                    SUPPLY THE MAIN LINK DETAILS USING FORM BELOW
                                </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <asp:TextBox ID="txtMinMark" runat="server" CssClass="form-control" placeholder="Enter text" />
                                        </div>
                                        <div class="col-lg-6">
                                            <label>Maximum Mark</label>
                                            <asp:TextBox ID="txtMaxMark" runat="server" CssClass="form-control" placeholder="Enter text" />
                                        </div>
                                    </div>
                                    <br />
                                    <div class="row">
                ...
                <div class="row" style="padding-top: 70px;">
                    ...
                    <div class="col-lg-8">
                        <div class="alert alert-info">
                            This Main Link Already Exists! Are you sure you want to Update it.
                        </div>
                    </div>
                    <div class="col-lg-2"></div>
                </div>
