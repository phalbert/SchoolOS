...
public partial class CustomUserControls_ChangeStudentProfile : System.Web.UI.UserControl
{
    ...
    private void LoadData()
    {
        ...
        bll.LoadDataIntoDropDown("GetStudentsForDropDown", new string[] { user.SchoolDetails.SchoolCode,"ALL" }, ddSystemUsers);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Student oldUser = bll.GetStudentById(user.User.Username,user.User.SchoolCode);
            ...
            if (SharedCommons.SharedCommons.GenearetHMACSha256Hash(oldUser.SecretKey, OldPassword) != oldUser.Password)
            {
            ...
            int rowsAffected = schoolApi.ExecuteNonQuery("ChangeStudentPassword", new string[] { user.User.Username, hashedNewPassword,user.User.SchoolCode });
