...
public partial class ListFees : System.Web.UI.UserControl
{
    ...
    private void SearchDB()
    {
        ...
        DataTable dt = bll.SearchTable("SearchSchoolFeesTable", searchParams);
        if (dt.Rows.Count > 0)
        {
    ...
    private string[] GetSearchParameters()
    {
        ...
        string StudentId = txtFeeName.Text;
        all.Add(name);
        all.Add(StudentId);
        return all.ToArray();
    }
