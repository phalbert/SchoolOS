...
public partial class CustomUserControls_SaveMainLink : System.Web.UI.UserControl
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string msg = "";
            MainLink aclient = GetObject();
            Result result = schoolApi.SaveMainLink(aclient);
    ...
    private MainLink GetObject()
    {
        MainLink std = new MainLink();
        std.MainLinkCode = SharedCommons.SharedCommons.GenerateUniqueId("MAIN-LINK");
        std.MainLinkName = txtName.Text;
