<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SaveExam.ascx.cs" Inherits="CustomUserControls_SaveExam" %>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-heading text-center">
                                    SUPPLY THE EXAM DETAILS USING FORM BELOW
                                </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <br />
                                    <div class="row" id="divToHide" runat="server" visible="false">
                                        <div class="col-lg-6">
                                            <label>Exam Code</label>
                                            <asp:TextBox ID="txtExamCode" runat="server" CssClass="form-control" placeholder="Enter text" />
                                        </div>
                                    </div>
                                    <br />
