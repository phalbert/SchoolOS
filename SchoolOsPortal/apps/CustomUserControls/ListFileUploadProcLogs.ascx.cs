...
public partial class CustomUserControls_ListFileUploadProcLogs : System.Web.UI.UserControl
{
    ...
    private void SearchDB()
    {
        ...
        DataTable dt = bll.SearchTable("SearchFileUploadLogsTable", searchParams);
        if (dt.Rows.Count > 0)
        {
