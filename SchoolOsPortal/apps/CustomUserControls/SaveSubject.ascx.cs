...
public partial class SaveSubject : System.Web.UI.UserControl
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string msg = "";
            Subject aclient = GetClient();
            Result result = schoolApi.SaveSubject(aclient);
    ...
    private Subject GetClient()
    {
        Subject std = new Subject();
        std.SubjectCode = SharedCommons.SharedCommons.GenerateUniqueId("SUB");
        std.SubjectName = txtName.Text;
