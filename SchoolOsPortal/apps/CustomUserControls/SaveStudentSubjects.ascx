<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SaveStudentSubjects.ascx.cs" Inherits="CustomUserControls_SaveStudentSubjects" %>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-heading text-center">
                                    SUPPLY THE DETAILS USING FORM BELOW
                                </div>
