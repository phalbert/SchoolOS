<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SaveSublink.ascx.cs" Inherits="CustomUserControls_SaveSublink" %>
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <label>URL</label>
                                            <asp:DropDownList ID="ddURLs" runat="server" CssClass="form-control">
                                                <asp:ListItem>True</asp:ListItem>
                                                <asp:ListItem>False</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                ...
                <div class="row" style="padding-top: 70px;">
                    ...
                    <div class="col-lg-8">
                        <div class="alert alert-info">
                            This SubLink Already Exists! Are you sure you want to Update it.
                        </div>
                    </div>
                    <div class="col-lg-2"></div>
                </div>
