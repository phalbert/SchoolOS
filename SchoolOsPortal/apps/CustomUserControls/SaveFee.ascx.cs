...
public partial class SaveFee : System.Web.UI.UserControl
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string msg = "";
            SchoolFee aclient = GetClient();
            Result result = schoolApi.SaveSchoolFees(aclient);
