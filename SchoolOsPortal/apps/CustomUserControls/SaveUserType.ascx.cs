...
public partial class CustomUserControls_SaveUserType : System.Web.UI.UserControl
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string msg = "";
            UserType aclient = GetObject();
            Result result = schoolApi.SaveUserType(aclient);
    ...
    private UserType GetObject()
    {
        UserType std = new UserType();
        std.UserTypeCode = SharedCommons.SharedCommons.GenerateUniqueId("USERTYPE");
        std.UserTypeName = txtName.Text;
