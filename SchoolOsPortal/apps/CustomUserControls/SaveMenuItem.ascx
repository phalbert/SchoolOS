<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SaveMenuItem.ascx.cs" Inherits="CustomUserControls_SaveMenuItem" %>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                         <div class="col-lg-6">
                                            <label>MainLink Name</label>
                                            <asp:DropDownList ID="ddMainLinks" OnSelectedIndexChanged="ddMainLinks_SelectedIndexChanged" runat="server" CssClass="form-control">
                                                <asp:ListItem>True</asp:ListItem>
                                                <asp:ListItem>False</asp:ListItem>
                                            </asp:DropDownList>
                                        ...
                                        <div class="col-lg-3">
                                            <label>SubLink</label>
                                            <asp:DropDownList ID="ddSubLinks" runat="server" CssClass="form-control">
                                                <asp:ListItem>True</asp:ListItem>
                                                <asp:ListItem>False</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-lg-1" style="padding-top: 25px;padding-right:10px">
                                             <asp:Button ID="btnAddSubLink" runat="server" Text="Add SubLink" CssClass="btn btn-success btn-md" OnClick="btnAddSubLink_Click" />
                                        </div>
                                    </div>
                                    <br />
                                    <br />
                ...
                <div class="row" style="padding-top: 70px;">
                    ...
                    <div class="col-lg-8">
                        <div class="alert alert-info">
                            This MenuItem Already Exists! Are you sure you want to Update it.
                        </div>
                    </div>
                    <div class="col-lg-2"></div>
                </div>
