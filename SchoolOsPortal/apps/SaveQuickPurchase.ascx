<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SaveQuickPurchase.ascx.cs" Inherits="SaveQuickPurchase" %>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row" id="Complex" runat="server">
                                         <div class="col-lg-6">
                                            <label>Invoice Number</label>
                                            <asp:TextBox ID="txtInvoiceNumber" Text="0.00" runat="server" CssClass="form-control" placeholder="Enter text" onkeyup="javascript:this.value=Comma(this.value);" />
                                            <p class="help-block">The total of the invoice(with out taxes)</p>
                                        </div>
                                    </div>
                                </div>
