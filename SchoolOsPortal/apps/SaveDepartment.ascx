<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SaveDepartment.ascx.cs" Inherits="SaveDepartment" %>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-heading text-center">
                                    SUPPLY DEPARTMENT DETAILS USING THE FORM BELOW
                                </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <p class="help-block">Unique ID for Department</p>
                                        </div>
                                    </div>
                                </div>
