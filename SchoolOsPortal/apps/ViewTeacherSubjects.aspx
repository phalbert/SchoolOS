<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="ViewTeacherSubjects.aspx.cs" Inherits="ViewTeacherSubjects" %>
            ...
            <div class="row">
                <ul class="nav nav-tabs" style="padding-top: 50px;">
                    <li id="ListClassesLink" runat="server" class="active">
                        <asp:LinkButton ID="ListClassesLinkButton" runat="server" OnClick="btnTabPane_Click">View Teacher's Subjects</asp:LinkButton>
                    </li>
                </ul>
            </div>
