<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListFees.ascx.cs" Inherits="ListFees" %>
    ...
    <asp:View ID="SearchView" runat="server">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <asp:TextBox ID="txtFeeName" runat="server" CssClass="form-control" placeholder="Enter text" />
            </div>
