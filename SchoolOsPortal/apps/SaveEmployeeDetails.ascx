<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SaveEmployeeDetails.ascx.cs" Inherits="SaveEmployeeDetails" %>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-heading text-center">
                                    SUPPLY THE EMPLOYEE DETAILS USING FORM BELOW
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                         ...
                                         <div class="col-lg-6">
                                            ...
                                            <asp:DropDownList ID="ddDepartments" runat="server" CssClass="form-control">
                                                <asp:ListItem>False</asp:ListItem>
                                                <asp:ListItem>True</asp:ListItem>
                                            </asp:DropDownList>
                                            <p class="help-block">The Name of the Department</p>
                                        </div>
                                    </div>
